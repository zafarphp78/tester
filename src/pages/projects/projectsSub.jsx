...
export default function ProjectsSubDetails({ cardData, title, titleSub }) {
    const details = [
        {
            img: profile,
            title: "client",
    ...
    return (<>
            ...
            <div className="lg:container xl:px-40 px-4 mx-auto md:mt-20 mt-10">
                <div className="grid md:grid-cols-2 grid-cols-1 md:gap-16 gap-8 items-center">
                    <div>
                        <Title title={`What ${titleSub}`} customClass="lg:after:w-[28rem] md:after:w-[16rem] after:w-[19rem]"/>
...
//# sourceMappingURL=projectsSub.jsx.map