...
const SliderHome = () => {
    ...
    return (<div className="md:mt-10 relative">
            <div className="mb-8">
            ...
            <Swiper modules={[Navigation]} navigation={true} spaceBetween={30} breakpoints={{
            576: {
                // width: 576,
                slidesPerView: 1,
            },
...
const SlideOne = ({ slider }) => {
    return (<div className="md:px-10 px-6 pt-20 md:pb-10 pb-6 rounded-md relative mt-12" style={{ background: slider.bgColor }}>
...
//# sourceMappingURL=sliderHome.jsx.map