    ...
    return (<div>
            <div className="grid md:grid-cols-2 grid-cols-1 md:gap-20 md:mt-10 mt-5 items-center">
                <div className="xl:pr-20">
                    <Title title="Providing The World's Best User Experiences" customClass="xl:after:w-[13rem] lg:after:w-[24rem] md:after:w-[24rem] after:w-[9rem]"/>
...
//# sourceMappingURL=cardBestUserExperience.jsx.map