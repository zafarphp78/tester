...
export const Card = ({ background, img, title, desc, link }) => {
    return (<div className="flex flex-col items-center justify-center text-center gap-4 px-8 py-16 rounded-md" style={{ background: background }}>
            <img src={img}/>
...
//# sourceMappingURL=cardWhatWeProvide.jsx.map