...
export const Card = ({ backgroundColor, img, title, path }) => {
    return (<Link to={path ? path : ""} className={`pt-12 px-4 rounded ${path ? "cursor-pointer" : "cursor-default"}`} style={{ background: backgroundColor }}>
...
//# sourceMappingURL=cardOurProjects.jsx.map