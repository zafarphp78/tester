...
const Brands = forwardRef(function (props, ref) {
    const images = [behance, cocacola, google, dribbble, amazon];
    return (<div ref={ref} className="flex flex-wrap md:justify-between justify-center items-center md:gap-4 gap-8 md:mt-20 mt-10">
